...
public class RecordService {
    ...
    @Transactional
    public RecordResponse createRecordWithHashtags(User user, RecordRequest recordRequest, MultipartFile image) throws IOException {
    ...
    @Transactional
    public RecordResponse createRecordWithoutHashtags(User user, RecordRequest recordRequest, MultipartFile image) throws IOException {
    ...
    private String uploadStorage(User user, MultipartFile image) throws IOException {
        ...
        String objectName = folderName + user.getId().toString() + "/" + fileName + System.currentTimeMillis() + "." + fileType;
